...
//                 //currentstop + students ( when active only)
...
//   const _TripInfoCard({required this.scheme, required this.trip});
//   @override
...
//   const _TripActionBar({required this.scheme, required this.tripState});
//   @override
//   Widget build(BuildContext context, WidgetRef ref) {
//     final isActive = tripState.screenState == TripScreenState.active;
//     final isLoading =
